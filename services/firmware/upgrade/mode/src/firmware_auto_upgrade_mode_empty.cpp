...
{
    FIRMWARE_LOGI("FirmwareAutoUpgradeMode::SetCheckResult fake");
}

void FirmwareAutoUpgradeMode::SetInstallResult(const InstallCallbackInfo &installCallbackInfo)
{
    FIRMWARE_LOGI("FirmwareAutoUpgradeMode::SetInstallResult fake");
}

void FirmwareAutoUpgradeMode::HandleComplete()
{
    FIRMWARE_LOGI("FirmwareAutoUpgradeMode::HandleComplete fake");
}
